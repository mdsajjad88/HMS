...
class CreatePatientAttachmentsBkTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('patient_attachments_bk', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('patient_attachments_bk');
    }
}
